...
frases[kind::party].push_back("Put a piece of ice down your shirt \nand dance until it shakes out.");
frases[kind::party].push_back("Call up a friend and tell them \nhow excited you are about armpits");
frases[kind::party].push_back("Start singing a pop song out loud \nlike you’re singing opera");
...
frases[kind::random].push_back("Serve a drink to the one \nwho accussed you");
...
frases[kind::random].push_back("Answer, \nHow old were you when you had your first kiss?");
...
frases[kind::random].push_back("Drink a mystery brew \nconcocted by the rest of the group");
...
frases[kind::random].push_back("Exchange clothes with a member \nof the opposite sex");
...
frases[kind::random].push_back("Answer, how many guys have you slept with? \nHow many girls?");
frases[kind::random].push_back("Answer, how old was the oldest person \nyou have slept with?");
frases[kind::random].push_back("Put a piece of ice down your shirt \nand dance until it shakes out.");
...
frases[kind::random].push_back("Pretend someone’s hair is your crush \nand ask it out");
frases[kind::random].push_back("Start singing a pop song out loud \nlike you’re singing opera");
...
frases[kind::random].push_back("Kiss and lick a beer bottle \nas though you are giving a blowjob");
...
frases[kind::random].push_back("Answer, If you had 1,000,000 dollars to give away, \nhow would you do it?");
...
frases[kind::drinking].push_back("Drink a mystery brew \nconcocted by the rest of the group");
...
frases[kind::drinking].push_back("Kiss and lick a beer bottle as though \nyou are giving a blowjob, then drink it");
...
frases[kind::erotic].push_back("Suck the finger of the player who acused you \nsensually");
...
frases[kind::erotic].push_back("Kiss and lick a beer bottle \nas though you are giving a blowjob");
...
frases[kind::erotic].push_back("Answer, Have you ever kissed or had sex \nwith someone of the same sex?");
